            ...
            <div class="swiper-wrapper">
                @foreach ($popularBoardingHouses as $popularBoardingHouse)
                    <div class="swiper-slide !w-fit">
                        <a href="{{ route('boarding-houses.show', $popularBoardingHouse->slug) }}" class="card">
                            <div
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        ...
                                        <p class="text-sm text-ngekos-grey">
                                            {{ $popularBoardingHouse->rooms->sum('capacity') }} People</p>
                                    </div>
                                    <hr class="border-[#F1F2F6]">
    ...
    <section id="Cities" class="flex flex-col p-5 gap-4 bg-[#F5F6F8] mt-[30px]">
        ...
        <div class="grid grid-cols-2 gap-4">
            @foreach ($cities as $city)
                <a href="{{ route('cities.show', $city->slug) }}" class="card">
                    <div
    ...
    <section id="Best" class="flex flex-col gap-4 px-5 mt-[30px]">
        ...
        <div class="flex flex-col gap-4">
            @foreach ($boardingHouses as $boardingHouse)
                <a href="{{ route('boarding-houses.show', $boardingHouse->slug) }}" class="card">
                    <div
                        ...
                        <div class="flex flex-col gap-3 w-full">
                            ...
                            <div class="flex items-center gap-[6px]">
                                <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0"
                                    alt="icon">
                                <p class="text-sm text-ngekos-grey">{{ $boardingHouse->rooms->sum('capacity') }} People
                                </p>
                            </div>
                            <hr class="border-[#F1F2F6]">
                            <p class="font-semibold text-lg text-ngekos-orange">Rp
